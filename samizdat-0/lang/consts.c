...
void constsInit(void) {
    ...
    STR_CH_CL_CURLY     = datStringletFromUtf8String("}", -1);
    STR_CH_CL_PAREN     = datStringletFromUtf8String(")", -1);
    STR_CH_CL_SQUARE    = datStringletFromUtf8String("]", -1);
    STR_CH_COLON        = datStringletFromUtf8String(":", -1);
    STR_CH_COLONCOLON   = datStringletFromUtf8String("::", -1);
    STR_CH_EQUAL        = datStringletFromUtf8String("=", -1);
    STR_CH_OP_CURLY     = datStringletFromUtf8String("{", -1);
    STR_CH_OP_PAREN     = datStringletFromUtf8String("(", -1);
    STR_CH_OP_SQUARE    = datStringletFromUtf8String("[", -1);
    ...
    STR_EXPRESSION      = datStringletFromUtf8String("expression", -1);
    ...
    STR_STATEMENT       = datStringletFromUtf8String("statement", -1);
    ...
    TOK_CH_CL_CURLY     = datMapletPut(empty, STR_TYPE, STR_CH_CL_CURLY);
    TOK_CH_CL_PAREN     = datMapletPut(empty, STR_TYPE, STR_CH_CL_PAREN);
    TOK_CH_CL_SQUARE    = datMapletPut(empty, STR_TYPE, STR_CH_CL_SQUARE);
    TOK_CH_COLON        = datMapletPut(empty, STR_TYPE, STR_CH_COLON);
    TOK_CH_COLONCOLON   = datMapletPut(empty, STR_TYPE, STR_CH_COLONCOLON);
    TOK_CH_EQUAL        = datMapletPut(empty, STR_TYPE, STR_CH_EQUAL);
    TOK_CH_OP_CURLY     = datMapletPut(empty, STR_TYPE, STR_CH_OP_CURLY);
    TOK_CH_OP_PAREN     = datMapletPut(empty, STR_TYPE, STR_CH_OP_PAREN);
    TOK_CH_OP_SQUARE    = datMapletPut(empty, STR_TYPE, STR_CH_OP_SQUARE);
    ...
    TOK_EXPRESSION      = datMapletPut(empty, STR_TYPE, STR_EXPRESSION);
    ...
    TOK_STATEMENT       = datMapletPut(empty, STR_TYPE, STR_STATEMENT);

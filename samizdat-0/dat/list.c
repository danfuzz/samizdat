...
void datBindList(void) {
    datGfnBindCore(genEq,     DAT_List, List_eq);
    datGfnBindCore(genGcMark, DAT_List, List_gcMark);
    datGfnBindCore(genOrder,  DAT_List, List_order);
    datGfnBindCore(genSizeOf, DAT_List, List_sizeOf);

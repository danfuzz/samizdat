...
void constsInit(void) {
    ...
    STR_EXPRESSIONS     = samStringletFromUtf8String("expressions", -1);
    ...
    TOK_EXPRESSIONS     = samMapletPut(empty, STR_TYPE, STR_EXPRESSIONS);

...
static zvalue tokenizeInt(ParseState *state) {
    ...
    return recordFrom1(RECNAME_int, SYM_value, intval);
}
...
static zvalue tokenizeIdentifier(ParseState *state) {
    ...
    return recordFrom1(RECNAME_identifier, SYM_value, name);
}
...
static zvalue tokenizeString(ParseState *state) {
    ...
    return recordFrom1(RECNAME_string, SYM_value, string);
}
...
static zvalue tokenizeDirective(ParseState *state) {
    ...
    return recordFrom2(RECNAME_directive,

...
Note that the license suggests that the following be included in
a header at the top of every file:

```
Copyright 2013 the Samizdat Authors.
...
Instead, this project chooses to use a more compact header:
